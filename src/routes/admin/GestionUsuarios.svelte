<script>
  ...
  const ROLES_DISPONIBLES = [
    { 
      key: 'coordinador_becas', 
      label: 'Coordinador de Becas' 
    },
    { 
      key: 'coordinador_dual', 
      label: 'Coordinador Dual' 
    },
    { 
...
<main class="main-container">
  <div class="content-wrapper">
    <div class="page-header">
      ...
      <p class="page-sub">Alta y gestión de accesos restringidos para coordinadores y directivos</p>
    </div>
                  ...
                  {#if p.roles && !p.roles.alumno}
                    <tr>
                      ...
                      <td style="text-align: center;">
                        {#if p.roles.admin}
                          <span 
                            style="display: inline-flex; padding: 6px; color: var(--text-disabled);" 
                        ...
                        {:else}
                          <button 
                            ...
                            on:click={() => darDeBaja(p.id, p.nombre)}
